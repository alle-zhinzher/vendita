    ...
    render() {
        ...
        return (
            <header>
                <div className="logo">
                    <img
                        src="http://127.0.0.1:8000/media/profile_pics/logo.svg"
                        alt="Logo" />
                ...
                <nav>
                    ...
                    <label
                        htmlFor="menu"
                        className="toggleMenu">
                        <img src="http://127.0.0.1:8000/media/profile_pics/burger.svg" /></label>
                    <ul>
                        <li>
                            <Link
                                className="link"
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <Link
                                            className="link"
                                            to="/vendita/user/book/purchased">
                                            purchased books
                                        </Link>
                                    </li>
                                    <li>
